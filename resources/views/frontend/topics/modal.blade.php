  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <p class="cls-modal-booking-text text-center text-primary">{{ __('Create success!') }}</p>
        <p class="text-center text-primary" style="margin-bottom: -2%; margin-top: -3%;">{{ __('Thank you! Please waiting for Admin approve!') }}</p>
      </div>
