  ...
  <div class="content-wrapper container">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb container">
        <li><a href="{{ route('admin.index') }}"><i class="fa fa-dashboard"></i> {{ __('User') }}</a></li>
        <li class="active">{{ __('Request join') }}</li>
      </ol>
    </section>

    <!-- Main content -->
    <section class="content container cls-font-20">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
              ...
              <table id="table-contain" class="table table-bordered table-responsive table-striped">
                ...
                <tbody>
                  @foreach ($userTopics as $userTopic)
                    @if ($userTopic->topic->own_user_id == Auth::user()->id)
                      {{-- expr --}}
                      <tr>
                      <td>{{ $userTopic->id }}</td>
                      <td>
