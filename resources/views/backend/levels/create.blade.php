...
@section('title', __('Levels | Create levels'))
            ...
            <form role="form" method="POST" action="{{ route('levels.store') }}">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control{{ $errors->has('name') ? ' has-error' : '' }}" name= "name" id="name" placeholder="{{ __('Enter level name') }}" value="{{ old('name') }}">
