...
@section('content')
  <div class="content-wrapper">
    ...
    <section class="content">
      <h1 class="title-page text-info clr-ml-15per">
        {{ __('Create user') }}
      </h1>
            ...
            <form role="form" method="POST" action="{{ route('user.store') }}">
              ...
              <div class="box-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  @if (old('is_admin') == App\User::ROLE_ADMIN)
                    <input type="checkbox" name="is_admin" value="{{ App\User::ROLE_ADMIN }}" checked>
                  @else
                    <input type="checkbox" name="is_admin" value="{{ App\User::ROLE_ADMIN }}">
                  @endif
                </div>
              </div>
              <!-- /.box-body -->
